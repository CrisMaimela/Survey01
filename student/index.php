...
{
	// Create and initialised variables to inputs sends as post
	...
	if (!empty($first_name) && !empty($last_name) && !empty($email)) 
	{
			...
			// Generate user_id
			$query = "INSERT INTO employee (user_id,first_name,last_name,email,password,confirm_password) VALUE ('$first_name','$last_name','$email',)";
